...
@Data
public class AccountLog implements Serializable, BaseRowInterface<AccountLog> {
...
//    @ApiModelProperty(value = "用户名")
    @ExcelProperty(value="账号名",index = 1)//使用我们的框架,要么都不写index,要么都写index
    @ExcelNotNull
    private String name;
...
//    private String operatorName;
    ...
    @ExcelProperty(value="方法名",index = 2)
    private String method;

    @ExcelProperty(value="方法参数列表",index = 3)
