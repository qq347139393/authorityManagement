...
public interface UserRoleRsMapper extends BaseMapper<UserRoleRs> {
    ...
    @Results(id="userRoleMap",value = {
            ...
            @Result(property = "roleInfo",column = "role_id",one=@One(select="com.planet.module.authManage.dao.mysql.mapper.RoleInfoMapper.selectById",fetchType= FetchType.EAGER))
    })
