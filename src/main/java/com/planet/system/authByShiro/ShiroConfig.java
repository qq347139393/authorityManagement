...
import com.planet.system.authByShiro.customSettings.RetryLimitCredentialsMatcher;
import com.planet.system.authByShiro.customSettings.ShiroCustomRealm;
import com.planet.system.authByShiro.customSettings.ShiroRedisSessionDao;
import com.planet.system.authByShiro.customSettings.ShiroSessionManager;
...
public class ShiroConfig {
    ...
    private Map<String, String> filterChainDefinition(){
        ...
        map.put("/authManage/account-module/login","anon");
        ...
        functionInfos.stream().forEach(functionInfo -> {
            map.put(functionInfo.getUrl(), "anon");
        });
