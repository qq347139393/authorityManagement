...
//    private static final String DEFAULT_PATH = "/oss";
    ...
    public SimpleUrlHandlerMapping swaggerUrlHandlerMapping(ServletContext servletContext,
        ...
        Map<String, ResourceHttpRequestHandler> urlMap = new HashMap<>();
        {
            ...
            //设置新的路径
            urlMap.put(ComponentConstant.SWAGGER2_DEFAULT_PATH + "/webjars/**", resourceHttpRequestHandler);
        }
        {
            PathResourceResolver pathResourceResolver = new PathResourceResolver();
            ...
            resourceHttpRequestHandler.afterPropertiesSet();
            //设置新的路径
            urlMap.put(ComponentConstant.SWAGGER2_DEFAULT_PATH + "/**", resourceHttpRequestHandler);
        }
    ...
    @Controller
    @ApiIgnore
    @RequestMapping(ComponentConstant.SWAGGER2_DEFAULT_PATH)
